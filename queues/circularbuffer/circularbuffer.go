...
func New[T comparable](maxSize int) *Queue[T] { _ = "STUB: not implemented"; return nil }
...
func (queue *Queue[T]) Full() bool { _ = "STUB: not implemented"; return false }
...
func (queue *Queue[T]) calculateSize() int { _ = "STUB: not implemented"; return 0 }
