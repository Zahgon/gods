...
func (heap *Heap[T]) Iterator() *Iterator[T] { _ = "STUB: not implemented"; return nil }
...
func numOfBits(n int) uint { _ = "STUB: not implemented"; return 0 }

func evaluateRange(index int) (start int, end int) { _ = "STUB: not implemented"; return 0, 0 }
